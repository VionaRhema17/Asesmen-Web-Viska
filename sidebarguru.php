...
$dataPages = ['datasiswa_disabled.php', 'datajurusan_disabled.php', 'dataagama_disabled.php'];
...
$ekstraPages = ['TARI.php', 'PASKIBRA.php', 'PRAMUKA.php', 'sidebar-mini.html', 'fixed-sidebar.html', 'layout-rtl.html'];
...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              <li class="nav-item <?= $currentPage == 'dashboardguru.php' ? 'menu-open' : '' ?>">
  <a href="dashboardguru.php" class="nav-link <?= $currentPage == 'dashboardguru.php' ? 'active' : '' ?>">
    ...
    <p>Tentang</p>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="datasiswa_disabled.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Data Siswa</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="datajurusan_disabled.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Data Jurusan</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="dataagama_disabled.php" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Data Agama</p>
                    </a>
                  </li>
